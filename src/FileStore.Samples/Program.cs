...
namespace FileStore.Samples
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      var fileStoreBuilder = FileStoreBuilder.Config(cfg => cfg.UseFileSystem("C:\\fileStore"));

      containerBuilder.Register(c => fileStoreBuilder.BuildUnversioned());
